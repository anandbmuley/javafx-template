...
JAVA_VERSION=17
MAIN_JAR="javafx-template-$PROJECT_VERSION.jar"
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/abm/javafxtemplate/SampleApp.class`
...
--name 'SampleApp' \
--main-class abm.javafxtemplate.AppLauncher \
--main-jar ${MAIN_JAR} \
--java-options -Xmx2048m \
--java-options -Dspring.profiles.active=mac \
--runtime-image target/java-runtime \
--icon src/main/logo/macosx/Logo.icns \
--app-version ${APP_VERSION} \
--vendor "ABM" \
--copyright "Copyright (C) ABM" \
--mac-package-identifier abm.javafxtemplate \
--mac-package-name SampleApp